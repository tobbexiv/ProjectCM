...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Adress.zip_code'
        db.alter_column('adressbook_adress', 'zip_code', self.gf('django.db.models.fields.IntegerField')(default=1))

    def backwards(self, orm):

        # Changing field 'Adress.zip_code'
        db.alter_column('adressbook_adress', 'zip_code', self.gf('django.db.models.fields.IntegerField')(null=True))

    models = {
        'adressbook.adress': {
            'Meta': {'object_name': 'Adress'},
            'contact_owner': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"}),
            'country': ('django.db.models.fields.CharField', [], {'blank': 'True', 'max_length': '60', 'null': 'True'}),
            ...
            'picture': ('django.db.models.fields.CharField', [], {'blank': 'True', 'max_length': '180', 'null': 'True'}),
            'street': ('django.db.models.fields.CharField', [], {'blank': 'True', 'max_length': '120', 'null': 'True'}),
            'telephone_nr': ('django.db.models.fields.IntegerField', [], {'blank': 'True', 'null': 'True'}),
            'town_name': ('django.db.models.fields.CharField', [], {'blank': 'True', 'max_length': '120', 'null': 'True'}),
